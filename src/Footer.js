    ...
    <footer className="footer" style={{ borderTop: "2px solid black" }}>
      <div className="footer-container">
        ...
        >
          ...
          <li>
            <a
              href="https://papaonwheels.com/tel:tel:+9181061%2089484"
          ...
          <li>
            <a
              href="mailto:papaofficial@gmail.com"
              className="tab-itam"
              rel="noopener noreferrer"
              target="_blank"
            >
              papaofficial24@gmail.com
            </a>
          </li>
        </FooterColumn>
        <FooterColumn title="">
          <div className="tabs">
            <li>
              <NavLink to="./" className="tab-itam1">
                Home
              </NavLink>
            </li>
            <li>
              <NavLink to="./About" className="tab-itam1">
                About Us
              </NavLink>
            </li>
            <li>
            ...
            <li>
              <NavLink to="./Contact " className="tab-itam1">
                Contact Us
              </NavLink>
            </li>
          </div>
        ...
        <FooterColumn title="Connect With Us">
          <div className="icons">
            <li className="icons">
              <a
                href="https://www.instagram.com/papaofficial_24/"
                rel="noopener noreferrer"
                target="_blank"
              >
                <img src={insta} alt="" width="45px" height="46px" />
              </a>
            </li>
            <li className="icons">
              <a
                href="https://www.facebook.com/profile.php?id=61557768754407"
                rel="noopener noreferrer"
                target="_blank"
              >
                <img src={fb} alt="" width="45px" height="46px" />
              </a>
            </li>
            <li className="icons">
              <a
                ...
                target="_blank"
              >
                <img src={yt} alt="" width="45px" height="46px" />
              </a>
            </li>
            <li className="icons">
              <a
                ...
                target="_blank"
              >
                <img src={li} alt="" width="45px" height="46px" />
              </a>
            </li>
          </div>
          <img
